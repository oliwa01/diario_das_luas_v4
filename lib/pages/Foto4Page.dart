...
class Foto4Page extends StatefulWidget {
  String codvenda;
  String nome;
  String email;
  String dataPicket1;
  ...
  @override
  _Foto4PageState createState() => _Foto4PageState();
}

class _Foto4PageState extends State<Foto4Page> {
                    ...
                    child: Column(
                        ...
                        children: <Widget>[
                          Align(
                              alignment: Alignment.topCenter,
                              child: SizedBox(
                                height: _mostraLayout ? 40 : 0,
                                child: Text(
                                    "Preencha os campos Nome e Data de nascimento, das pessoas do Mapa Lunar.",
                                    style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        color: Colors.white,
                                        fontSize: fontsizetitle)),
                              )),
                          SizedBox(height: _mostraLayout ? 40 : 0),
                          // texto input Nome Família
                          SizedBox(
                            height: _mostraLayout ? 40 : 0,
                            child: Text("Nome da Família",
                                style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    color: Colors.white,
                                    fontSize: 18)),
...
//   Nome Família
                          ...
                          //
                          // area de imagems a ser compartilhada
                          //
