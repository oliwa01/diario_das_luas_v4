...
class Foto6Page extends StatefulWidget {
  String codvenda;
  String nome;
  String email;
  String dataPicket1;
  ...
  @override
  _Foto6PageState createState() => _Foto6PageState();
}

class _Foto6PageState extends State<Foto6Page> {
...
//
  ...
  Future<void>_geraDados () async {
      ...
      _nome6 = widget.nome6;
      _dataDb6 = widget.dataPicket6;
      _signoDb6 = widget.signosdb6;
      _timeDb6 = widget.timedb6;
      _distanciaDb6 = widget.distancia6;
...
_geraDados();
  ...
  Widget build(BuildContext context) {
    ...
    int  luasize2 = (widthlua > 1400? 150 : widthlua > 1200? 125 : widthlua > 1100? 100: widthlua > 1000? 65 : widthlua > 800 ? 45 : 30);
    double nomesize2 = (widthlua > 1200? 10 : widthlua > 1000? 8 : widthlua > 800 ? 6 : 4);
    double datasize2 = (widthlua > 1200? 8 : widthlua > 1000? 7 : widthlua > 800 ? 6 : 5);
    double tipoluasize2 = (widthlua > 1200? 9: widthlua > 1000? 8 : widthlua > 800 ? 6 : 4);
    double distanciasize2 = (widthlua > 1200? 6: widthlua > 1000? 5 : widthlua > 800 ? 4 : 3);
    ...
    double tipoluzsize2 = (widthlua > 1200? 5: widthlua > 1000? 6 : widthlua > 800 ? 5 : 5);

    double boxnomesize2 = (widthlua > 1200? 80: widthlua > 1000? 70 : widthlua > 800 ? 50 : 40);
    double fontsizetitle = (widthlua > 1200? 28: widthlua > 1000? 20 : widthlua > 800 ? 15 : 10);
                                                      ...
                                                      Container(
                                                          ...
                                                          child: Column(
                                                            children: <Widget>[
                                                              ...
                                                              Text( _distanciaDb6.toString() == null ?  "Distancia :  +00.00" : "Distancia :  " + _distanciaDb6.toString()+ " Kms",
                                                                style: TextStyle(
                                                                  color: Colors.white,
                                                                  fontSize: distanciasize,
                                                                ),),
                  ...
                  children: [
                    Row(
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(width: 40),
                          SizedBox(
                              height: (_mostraImagem ? (widthlua > 1200? 50: widthlua > 1000? 40 : widthlua > 800 ? 30 :30) : 0),
                              child: MaterialButton(
                                color: Colors.deepOrange,
                                shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.all(
                                ...
                                child: const Text('Comprar esta foto - Arquivo Digital',style: TextStyle(color: Colors.white),
                                ),
                              )),
                          SizedBox(width: 40)
                        ]),
