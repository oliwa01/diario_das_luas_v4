...
class Page3Desktop extends StatefulWidget {
  String nome;
  String email;
  Page3Desktop(this.nome,this.email);
  @override
  _Page3DesktopState createState() => _Page3DesktopState();
}

class _Page3DesktopState extends State<Page3Desktop> {
...
//
                  ...
                  Container(
                      ...
                      height: _page2?heightlua* 0.90:0,
                      color: Colors.black,
                      child:Align(
                          alignment: Alignment.topCenter,
                          child: SingleChildScrollView( // horizontal scroll widget
