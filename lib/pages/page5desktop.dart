...
class Page5Desktop extends StatefulWidget {
  String nome;
  String email;
  Page5Desktop(this.nome,this.email);
  @override
  _Page5DesktopState createState() => _Page5DesktopState();
}

class _Page5DesktopState extends State<Page5Desktop> {
        ...
        child: Scaffold(
            ...
            body: Container(
                ...
                Column(
                    children: <Widget>[
                      Container(
                        height: _page2 ? heightlua *  0.90 - 56 : heightlua * 0.90 - 56 ,
                        child: Align(
